...
{else}
    ...
    <div class="crm-block crm-content-block crm-report-form-block">
        ...
        {assign var="bemasCellStyle" value="border-bottom: 1px solid #000000; padding-left: 10px; border-left: 1px solid #FFFFFF; border-right: 1px solid #FFFFFF; padding-right: 10px;"}
